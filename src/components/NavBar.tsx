...
export default function NavBar() {
  ...
  return (
    <nav className="w-full max-w-[480px] mx-auto mb-6">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex-1 flex flex-col items-center gap-1 py-2.5 rounded-xl text-[10px] font-medium transition-all duration-200 glow-btn ${
                active
